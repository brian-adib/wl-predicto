...
def train_poisson_models():
    ...
    # Agregar constante
    X_home = sm.add_constant(X[['diff_elo', 'home_attack', 'away_defense', 'form_home', 'neutral']])
    X_away = sm.add_constant(X[['diff_elo', 'away_attack', 'home_defense', 'form_away', 'neutral']])
    ...
    print("✅ Modelos Poisson entrenados y guardados.")
